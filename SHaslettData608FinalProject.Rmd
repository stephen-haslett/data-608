...
```{r confirmedCasesGlimpse, eval=TRUE, message=FALSE, warning=FALSE}
# Run the dataset through the describe() function.
describe(covid_ts_confirmed_cases)
```
...
```{r covidDeathsGlimpse, eval=TRUE, message=FALSE, warning=FALSE}
# Run the dataset through the describe() function.
describe(covid_ts_deaths)
```
...
```{r covidRecoveriesGlimpse, eval=TRUE, message=FALSE, warning=FALSE}
# Run the dataset through the describe() function.
describe(covid_ts_recovered)
```
